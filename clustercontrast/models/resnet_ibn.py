...
class ResNetIBN(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        if not self.cut_at_pooling:
            ...
            '''self.domain_classifier = nn.Linear(self.num_features, 15, bias=False)
            ...
            self.domain_classifier.add_module('d_fc3', nn.Linear(100, 20))
    ...
    def forward(self, x, alpha = -1):
        ...
        if self.num_classes > 0:
            ...
            if alpha == -1 :
                ...
                reverse_feature = ReverseLayerF.apply(bn_x, alpha)
