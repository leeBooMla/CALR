...
from clustercontrast.utils.infomap_cluster import get_cluster
from clustercontrast.visualization import evaluate_local_cluster
...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        ...
        lr_scheduler.step()
    #np.save('images/msmt17/cam9/pseudo_label.npy', np.array(pseudo_labeled_dataset))
