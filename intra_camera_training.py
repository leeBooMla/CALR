...
from calr.evaluators import Evaluator, extract_features
...
from calr.utils.infomap_cluster import get_cluster
from calr.visualization import evaluate_local_cluster
    ...
    for epoch in range(args.epochs):
        ...
        if (epoch + 1) % args.eval_step == 0 or (epoch == args.epochs - 1):
            ...
            if is_best:
                ...
                np.save('local_results/veri/cam20/pseudo_label.npy', np.array(pseudo_labeled_dataset))
