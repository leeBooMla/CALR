...
class ResNetIBN(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
                 num_features=0, norm=False, dropout=0, num_classes=0, pooling_type='avg', num_cams=0):
        ...
        if not self.cut_at_pooling:
            ...
            self.domain_classifier.add_module('d_fc1', nn.Linear(self.num_features, 100))
            ...
            self.domain_classifier.add_module('d_fc3', nn.Linear(100, num_cams))
    ...
    def forward(self, x, CA_flag = -1):
        ...
        if self.num_classes > 0:
            ...
            if CA_flag == -1 :
                ...
                reverse_feature = ReverseLayerF.apply(bn_x, CA_flag)
                domain_output = self.domain_classifier(reverse_feature)
                return bn_x, domain_output
        return prob, bn_x
